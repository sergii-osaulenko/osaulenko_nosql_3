...
Цей README навмисно містить не лише інструкції запуску, а й **відповіді на всі основні питання завдання, фактичні результати, пояснення алгоритмів, висновки та порівняння з SQL**.

---

# 0. Відповідність початковим критеріям

Початкові критерії оцінювання:

| Критерій | Вага | Що покриває цей пакет |
|---|---:|---|
| 1. Схема та якість аргументації | 15% | Розділ 1: схема, User/Movie/Genre, Rating relationship, Genre node |
| 2. Дані завантажені коректно, індекси, без дублів | 15% | Розділ 2: import, constraints, batching, контрольні counts |
| 3. Усі 6 запитів працюють і дають результати | 25% | Розділ 3: Q1–Q6 + фактичні результати |
| 4. Супервузли знайдені та стратегія обґрунтована | 15% | Розділ 4: degree analysis, thresholds, performance strategy |
| 5. Алгоритми GDS + результати + інтерпретація | 20% | Розділ 5: PageRank, Louvain, Dijkstra |
| 6. Розгорнутий порівняльний аналіз | 10% | Розділ 6: Graph vs SQL + improvements + conclusions |

**Висновок:** файл містить матеріал для кожного з 6 критеріїв.
