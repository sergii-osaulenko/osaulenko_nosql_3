...
## MovieLens 1M + Neo4j + GDS

Цей README містить інструкції запуску, відповіді на всі основні питання завдання, фактичні результати, пояснення алгоритмів, висновки та порівняння з SQL.
